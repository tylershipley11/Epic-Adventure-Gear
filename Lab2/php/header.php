...
<nav class="navbar">
        ...
        <!-- Navigation links -->
        <ul class="nav-items">
            <li><a href="main.php" class="<?php echo ($currentPage == 'main') ? 'active' : ''; ?>">Home</a></li>
            ...
            <li><a href="other.php" class="<?php echo ($currentPage == 'other') ? 'active' : ''; ?>">Other</a></li>
        </ul>
    </nav>